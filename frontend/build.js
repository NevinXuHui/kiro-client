...
// 复制 assets/fonts 目录到 dist/assets/fonts/（index.html 里 @font-face 引用该路径）
copyDir(path.join(assetsDir, 'fonts'), path.join(distAssetsDir, 'fonts'));
console.log('✓ 已复制 assets/fonts 目录');
...
const jsFiles = ['i18n.js', 'accounts.js', 'task.js', 'overview.js', 'app.js', 'cloudmail.js', 'ui.js', 'subscription.js', 'proxy_pool.js', 'pools.js', 'license.js', 'gateway.js', 'models.js'];
